...
ALGO_NAMES = ["GaussianNB", "DecisionTreeClassifier", "LogisticRegression", "MLPClassifier",
              "GradientBoostingClassifier", "HistGradientBoostingClassifier", "LinearDiscriminantAnalysis",
              "RandomForestClassifier", "GaussianProcessClassifier", "AdaBoostClassifier",
...
def analyse(my_dataset, alg_no):
    ...
    for line in range(0, num_lines):
        ...
        if alg_no == 0:
            ...
            clf = LogisticRegression(solver="liblinear", max_iter=1000, tol=0.000000001)
        elif alg_no == 3:
